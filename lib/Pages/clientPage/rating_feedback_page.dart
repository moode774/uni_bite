...
import 'package:uni_bite/localization/app_localizations.dart'; // Added localization import
  ...
  Future<void> _submitRating() async {
    ...
    if (widget.orderId == null ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(AppLocalizations.of(context).translate('store_order_info_not_available')))
      );
      return;
    }
    ...
    try {
      ...
      if (user == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(AppLocalizations.of(context).translate('please_login_to_submit')))
        );
        return;
      }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(AppLocalizations.of(context).translate('rating_submitted_successfully')))
      );
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            centerTitle: true,
            title: Text(
              AppLocalizations.of(context).translate("rating_feedback"),
            ...
            child: Column(
              ...
              children: [
                ...
                Align(
                  ...
                  child: Text(
                    AppLocalizations.of(context).translate("write_comments_here"),
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: AppLocalizations.of(context).translate("write_here"),
