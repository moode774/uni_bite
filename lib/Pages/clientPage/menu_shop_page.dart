...
class _MenuShopPageState extends State<MenuShopPage> {
  ...
  Future<List<Map<String, dynamic>>> _getProducts() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance
        .collection('products')
        .where('facilityId', isEqualTo: widget.storeDocId)
        .get();
        ...
        child: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, storeSnapshot) {
            ...
            if (storeSnapshot.hasError) {
              return Center(
                child: Text("${AppLocalizations.of(context).translate('error')}: ${storeSnapshot.error}"),
              );
            }
            if (storeSnapshot.data == null || storeSnapshot.data!.isEmpty) {
              return Center(
                child: Text(AppLocalizations.of(context).translate('store_not_found')),
              );
            }
            ...
            return FutureBuilder<List<String>>(
              ...
              builder: (context, categoriesSnapshot) {
                ...
                if (categoriesSnapshot.hasError) {
                  return Center(
                    child: Text("${AppLocalizations.of(context).translate('error_loading_categories')}: ${categoriesSnapshot.error}"),
                  );
                }
                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      storeData["name"] ?? AppLocalizations.of(context).translate('unknown'),
                                    ...
                                    Text(
                                      storeData["type"] ?? AppLocalizations.of(context).translate('store'),
                                      style: const TextStyle(
                                        fontSize: 16,
                                        color: Colors.grey,
                                      ),
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                String categoryKey = dynamicCategories[index].toLowerCase();
                                // If the category is 'All', use the 'all' translation key
                                if (categoryKey == 'all') {
                                  ...
                                  // For other categories, use the original text
                                  return GestureDetector(
                                    onTap: () => setState(() =>
                                        selectedCategory = dynamicCategories[index]),
                                    child: Container(
                            ...
                            child: FutureBuilder<List<Map<String, dynamic>>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                if (!snapshot.hasData || snapshot.data!.isEmpty) {
                                  return Center(
                                    child: Text(AppLocalizations.of(context).translate('no_products')),
                                  );
                                }
                                            ...
                                            Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    "${product["calories"]} ${AppLocalizations.of(context).translate('cal')}",
                                                    style: const TextStyle(
                                                      color: Colors.grey,
                                                      fontSize: 12,
                                                    ),
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      Text(
                                                        "${product["price"]} ${AppLocalizations.of(context).translate('sar')}",
                                                        style: const TextStyle(
                                                          fontSize: 14,
                                                          fontWeight: FontWeight.bold,
                                                        ),
                                                        ...
                                                        onTap: () {
                                                          ...
                                                          showDialog(
                                                            ...
                                                            builder: (ctx) => AlertDialog(
                                                              title: Text(AppLocalizations.of(context).translate('added')),
                                                              content: Text(
                                                                AppLocalizations.of(context).translate('added_to_cart').replaceAll('{item}', product["title"] ?? ""),
                                                              ),
                                                              actions: [
                                                                TextButton(
