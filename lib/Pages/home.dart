...
import 'package:uni_bite/Pages/clientPage/order.dart';
import 'package:uni_bite/Pages/clientPage/profile.dart';
import 'package:uni_bite/Pages/clientPage/menu_shop_page.dart';
import 'package:uni_bite/Pages/clientPage/order.dart' as order_page;
...
class _HomeState extends State<Home> {
  ...
  // قائمة التصنيفات مع مفاتيح الترجمة
  ...
  void initState() {
    super.initState();
    _loadFavorites();
    // تعريف مفاتيح الترجمة للتصنيفات
    categoryKeys = ['all', 'restaurants', 'cafes', 'top_rated'];
  }
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      AppLocalizations.of(context).translate('order_now_message'),
                        ...
                        children: List.generate(
                          ...
                          (index) => GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                AppLocalizations.of(context).translate(categoryKeys[index]),
                                style: TextStyle(
                                  color: _selectedCategoryIndex == index
                                      ? Colors.white
                                      : Colors.blueGrey,
