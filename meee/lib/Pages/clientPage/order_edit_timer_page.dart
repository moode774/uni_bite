            ...
            child: Column(
              ...
              children: [
                ListTile(
                  ...
                  onTap: () => Navigator.pop(context, 'Changed my mind'),
                ),
                ListTile(
                  title: const Text('Found a better option'),
                  onTap: () => Navigator.pop(context, 'Found a better option'),
                ),
                ListTile(
                  title: const Text('Order mistake'),
                  onTap: () => Navigator.pop(context, 'Order mistake'),
                ),
                ListTile(
                  title: const Text('Delivery delay'),
                  onTap: () => Navigator.pop(context, 'Delivery delay'),
                ),
                ListTile(
                  title: const Text('I prefer not to say'),
                  onTap: () => Navigator.pop(context, 'I prefer not to say'),
                ),
              ],
            ),
          ),
